...
export const routes: Routes = [
  // -------------------- 🌐 Customer (الزبائن) --------------------
  {
    path: 'customer/login',
    loadComponent: () =>
      import('./features/auth-customer/login/login.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/auth-customer/register/register.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './features/auth-customer/reset-password/reset-password.component'
  ...
  //
  {
    ...
    loadComponent: () =>
      import('./features/auth-customer/reset-sent/reset-sent.component').then(
        (m) => m.ResetSentComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import(
        './features/auth-customer/password-success/password-success.component'
      ).then((m) => m.PasswordSuccessComponent),
  },
  {
    path: 'customer/new-password',
    loadComponent: () =>
      import(
        './features/auth-customer/new-password/new-password.component'
  ...
  // -------------------- ️ Customer Admin Auth --------------------
  {
    ...
    loadComponent: () =>
      import('./features/auth-admin/login/login.component').then(
        (m) => m.CustomerLoginComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('./features/auth-admin/register/register.component').then(
        (m) => m.RegisterComponent,
      ),
  },
  ...
  // -------------------- 🧭 Admin Layout + Child Pages --------------------
  {
    ...
    children: [
      ...
      },
      {
        path: 'grow',
        loadComponent: () =>
          import('./features/admin/grow/grow.component').then(
            (m) => m.GrowComponent,
          ),
      },
      {
        path: 'customer',
        loadComponent: () =>
          import('./features/admin/customer/customer.component').then(
      ...
      },
      {
        path: 'connect',
        loadComponent: () =>
          import('./features/admin/connect/connect.component').then(
      ...
      },
      {
        path: 'integrations',
        loadComponent: () =>
          import('./features/admin/integrations/integrations.component').then(
